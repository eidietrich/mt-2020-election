  ...
  render() {
    ...
    return <Layout>
      ...
      <div className={`text ${styles.body}`}>
        ...
        <p>This year’s primary election was conducted without in-person polling because of the coronavirus pandemic (more on that later). It’s unclear for now how the pandemic may impact the general election.</p>
        <p>In the event the general election is held as an all-mail election like the June primary, your ballot will be mailed to you if you’re registered to vote. Simply fill it out and mail it back in (return postage will be included), or drop it off at your county’s drop-off location. We’ll list those addresses a little farther down.</p>
